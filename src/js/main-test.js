...
// const sheetNames1 = workbook1.getWorksheetNames();
// const sheetNames2 = workbook2.getWorksheetNames();

// const comparisonResults = {};

// for (let sheetName of sheetNames1) {
//   const worksheet1 = workbook1.getWorksheet(sheetName);
//   const worksheet2 = workbook2.getWorksheet(sheetName);

//   for (let row = 1; row <= worksheet1.rowCount; row++) {
//     for (let col = 1; col <= worksheet1.columnCount; col++) {
//       const cell1 = worksheet1.getCell(row, col);
//       const cell2 = worksheet2.getCell(row, col);
...
//         comparisonResults[cellAddress] = {
//           firstFileName: input_files_1[0].name,
//           firstCellName: `${cell1.name}`,
//           firstFile: `${cell1.value}`,
//           secondFileName: input_files_2[0].name,
//           secondCellName: `${cell2.name}`,
//           secondFile: `${cell2.value}`,
//         };
